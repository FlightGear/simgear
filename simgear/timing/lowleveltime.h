...
// SPDX-FileCopyrightText: 1999 Durk Talsma and others, including glibc authors

/**
 * @brief This file redefines some low-level Unix-like time functions, adapted from
 * glibc functions for use with FlightGear.
 *
 * Most notably, localtime() is adapted to use a custom timezone, in order to get the
 * 'local' time for a given aircraft's position, and not only for the current location
